...
export const APIS = [ContractControllerService, FileControllerService, MailControllerService, OtpControllerService, PushNotificationControllerService, SigningPositionControllerService, SmsControllerService, TemplateNotificationControllerService];
