...
export class RepaymentControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public gpayRepaymentPaydayLoanHmg(repaymentRequest: RepaymentRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ApiResponseGpayRepaymentResponse>;
    public gpayRepaymentPaydayLoanHmg(repaymentRequest: RepaymentRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ApiResponseGpayRepaymentResponse>>;
    public gpayRepaymentPaydayLoanHmg(repaymentRequest: RepaymentRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ApiResponseGpayRepaymentResponse>>;
    public gpayRepaymentPaydayLoanHmg(repaymentRequest: RepaymentRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (repaymentRequest === null || repaymentRequest === undefined) {
            throw new Error('Required parameter repaymentRequest was null or undefined when calling gpayRepaymentPaydayLoanHmg.');
        }
        ...
        return this.httpClient.post<ApiResponseGpayRepaymentResponse>(`${this.configuration.basePath}/v1/repayment/gpay/paydayloan-hmg`,
            repaymentRequest,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
