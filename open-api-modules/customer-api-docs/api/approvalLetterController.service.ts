...
import { ApiResponseListApprovalLetter } from '../model/models';
...
export class ApprovalLetterControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getListApprovalLetterByCustomerId(customerId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ApiResponseListApprovalLetter>;
    public getListApprovalLetterByCustomerId(customerId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ApiResponseListApprovalLetter>>;
    public getListApprovalLetterByCustomerId(customerId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ApiResponseListApprovalLetter>>;
    public getListApprovalLetterByCustomerId(customerId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (customerId === null || customerId === undefined) {
            throw new Error('Required parameter customerId was null or undefined when calling getListApprovalLetterByCustomerId.');
        }
