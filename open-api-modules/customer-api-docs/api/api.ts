...
export const APIS = [ApprovalLetterControllerService, CompanyControllerService, InfoControllerService, InfoV2ControllerService, KalapaControllerService, KalapaV2ControllerService, NewsletterControllerService, NotificationControllerService, TngControllerService];
