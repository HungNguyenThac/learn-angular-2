...
export class PaydayLoanControllerService {
    ...
    public changeLoanStatus(loanId: string, updateLoanStatusRequest: UpdateLoanStatusRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<ApiResponseString>(`${this.configuration.basePath}/v1/paydays/${encodeURIComponent(String(loanId))}/changeStatus`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createApplication(createApplicationRequest: CreateApplicationRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ApiResponseApplyResponse>;
    public createApplication(createApplicationRequest: CreateApplicationRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ApiResponseApplyResponse>>;
    public createApplication(createApplicationRequest: CreateApplicationRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ApiResponseApplyResponse>>;
    public createApplication(createApplicationRequest: CreateApplicationRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<ApiResponseApplyResponse>(`${this.configuration.basePath}/v1/paydays`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findLoan(loanId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ApiResponsePaydayLoan>;
    public findLoan(loanId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ApiResponsePaydayLoan>>;
    public findLoan(loanId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ApiResponsePaydayLoan>>;
    public findLoan(loanId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (loanId === null || loanId === undefined) {
        ...
        return this.httpClient.get<ApiResponsePaydayLoan>(`${this.configuration.basePath}/v1/paydays/${encodeURIComponent(String(loanId))}`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getActivePaydayLoan1(customerId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<ApiResponsePaydayLoan>(`${this.configuration.basePath}/v1/paydays/${encodeURIComponent(String(customerId))}/activeLoan`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getLoanByStatus(status: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<ApiResponseListPaydayLoan>(`${this.configuration.basePath}/v1/paydays/getByStatus`,
            {
    ...
    public getLoanContractByLoanId(loanId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<ApiResponseContract>(`${this.configuration.basePath}/v1/paydays/${encodeURIComponent(String(loanId))}/contracts`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getServiceToken(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined}): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/v1/paydays/getServiceToken`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public notifyBeforeGetSalary(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<ApiResponseString>(`${this.configuration.basePath}/v1/paydays/cronjob/notifyBeforeGetSalary`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public setLoanOverdue(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<ApiResponseString>(`${this.configuration.basePath}/v1/paydays/cronjob/overdue`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public updateInfo(loanId: string, updateLoanRequest: UpdateLoanRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.put<ApiResponseObject>(`${this.configuration.basePath}/v1/paydays/${encodeURIComponent(String(loanId))}`,
            updateLoanRequest,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateLatePenaltyPayment(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ApiResponseString>;
    public updateLatePenaltyPayment(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ApiResponseString>>;
    public updateLatePenaltyPayment(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ApiResponseString>>;
    public updateLatePenaltyPayment(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<ApiResponseString>(`${this.configuration.basePath}/v1/paydays/cronjob/latePayment`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public withdraw(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<ApiResponseString>(`${this.configuration.basePath}/v1/paydays/cronjob/withdrawLoan`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
