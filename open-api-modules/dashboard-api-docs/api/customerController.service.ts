...
import { ApiResponseCustomerInfo } from '../model/models';
import { ApiResponseSearchAndPaginationResponseCustomerInfo } from '../model/models';
...
export class CustomerControllerService {
     ...
     */
    public getCustomerById(customerId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ApiResponseCustomerInfo>;
    public getCustomerById(customerId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ApiResponseCustomerInfo>>;
    public getCustomerById(customerId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ApiResponseCustomerInfo>>;
    public getCustomerById(customerId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<ApiResponseCustomerInfo>(`${this.configuration.basePath}/v1/customers/${encodeURIComponent(String(customerId))}`,
            {
    ...
    public getCustomers(pageSize: number, pageNumber: number, requestBody: { [key: string]: object; }, orderBy?: string, descending?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        if (pageNumber === null || pageNumber === undefined) {
            throw new Error('Required parameter pageNumber was null or undefined when calling getCustomers.');
        }
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling getCustomers.');
        }
        ...
        return this.httpClient.post<ApiResponseSearchAndPaginationResponseCustomerInfo>(`${this.configuration.basePath}/v1/customers`,
            requestBody,
            {
