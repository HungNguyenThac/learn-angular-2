...
export class BaseBreadcrumbComponent implements OnInit {
  ...
  @Input() searchPlaceholder: string = 'Họ tên, Mã nhân viên, Số điện thoại, Email...';
  @Input() searchFields: string[] = [];
  @Input() searchable: boolean = true;
  @Input() extendActionLabel: string;
  @Input() btnAddText: string;
  @Input() showBtnAdd: boolean = false;

  @Output() submitSearchForm: EventEmitter<string>;
  @Output() clickBtnAdd: EventEmitter<string>;
